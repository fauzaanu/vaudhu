...
class GasimSpider(CrawlSpider):
    # call C:\Users\fauzaanu\PycharmProjects\vaudhu\venv\scripts\python.exe -m scrapy crawl harmonize
    name = "harmonize" # gasim, harmonize same thing :D
    allowed_domains = [""] # please add the manifesto here someone... :D
    start_urls = [""]
    rules = (
